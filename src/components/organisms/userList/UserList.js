					...
					{users.map((user,index) => (
						<tr key={index}>
							...
							<td>
								...
								>
									...
									<div className="user-detail-container">
										...
										<div class="user-information">
											...
											<div><i className="fa-solid fa-user"></i> {user.login.username}</div>
											<div><i className="fa-solid fa-mobile-screen-button"></i>{user.cell}</div>
											<div><i className="fa-solid fa-location-pin"></i> {user.location.country}</div>
								...
								<i className="fa-solid fa-trash-can" onClick={() => onRemove(user.id.value)}></i>
							</td>
						</tr>
					))}
				</tbody>
